        ...
        ? data.data
          ? (setDataAPIResearch(
              data.data.map((data) => ({
                ...
                customQuotationAirDetailForBooking:
                  data.customQuotationAirDetailForBooking,
              }))
            ),
            setShowError(false))
          : setShowError(true)
  ...
  const columns: ColumnsType<IQuotationCustomsTable> = [
    {
      ...
      render: (value, record) => {
        return formatNumber(
          Number(record.customQuotationAirDetailForBooking?.priceGreenLane) ||
            '0'
        );
      },
    },
    {
      ...
      render: (value, record) => {
        return formatNumber(
          Number(record.customQuotationAirDetailForBooking?.priceYellowLane) ||
            '0'
        );
      },
    },
    {
      ...
      render: (value, record) => {
        return formatNumber(
          Number(record.customQuotationAirDetailForBooking?.priceRedLane) || '0'
        );
      },
    },
  ];
