...
import { IQuotationDetail } from '../../interface';
interface Props {
    ...
    <div className={style.information}>
      <Flex className={style.header} align="center">
        ...
        <div className={style.title}>
          {dataQuotation?.pickupName} - {dataQuotation?.deliveryName}
        </div>
      </Flex>
          ...
          <Col span={24} lg={16} style={{ paddingBottom: '24px' }}>
            <Row>
              <Col sm={12} span={24} style={{ paddingBottom: '16px' }}>
                <div>From</div>
                <div className={style.nameFrom}>
                  {dataQuotation?.pickupName}
                </div>
                {/* <div>11/05/2003</div> */}
              </Col>
              <Col sm={12} span={24}>
            ...
            <Row>
              <Col span={24} style={{ marginBottom: '12px' }}>
                <Flex align="center">
                  ...
                  <div>
                    <div className={style.nameFrom}>Place of pick up</div>
